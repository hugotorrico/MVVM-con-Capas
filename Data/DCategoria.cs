    ...
    public class DCategoria
    {
                    ...
                    CommandType.StoredProcedure, parameters))
                {
                    ...
                    while (reader.Read())
                    {
                        categorias.Add(new Categoria
                        {
                            ...
                            Desripcion = reader["descripcion"] != null ? Convert.ToString(reader["descripcion"]) : string.Empty,
                        });
                    }
                }
            }
        ...
        public void Insertar(Categoria categoria)
        {
            ...
            try
            {
                ...
                parameters[1].Value = categoria.Desripcion;
        ...
        public void Actualizar(Categoria categoria)
        {
            ...
            try
            {
                ...
                parameters[2].Value = categoria.Desripcion;
                SqlHelper.EjecutarSentenciaSQL(SqlHelper.Connection, comandText, CommandType.StoredProcedure, parameters);
            }
            catch (Exception ex)
            {
